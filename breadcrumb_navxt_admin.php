...
if(version_compare(phpversion(), '5.2.0', '<'))
{
	...
	function bcn_phpold()
	{
		printf('<div class="error"><p>' . __('Your PHP version is too old, please upgrade to a newer version. Your version is %s, Breadcrumb NavXT requires %s', 'breadcrumb-navxt') . '</p></div>', phpversion(), '5.2.0');
	}
